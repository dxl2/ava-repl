...
COMMAND_MAP[platform]="createBlockchain addValidator addDelegator getTx getCurrentSupply getHeight getBlockchains getStake getMinStake getStakingAssetID getBlockchainStatus validates validatedBy sampleValidators createAddress listAddresses listBalances getBalance createSubnet getSubnets getTxStatus importAVAX exportAVAX issueTx addSubnetValidator getPendingValidators getCurrentValidators isCurrentValidator exportKey importKey"
